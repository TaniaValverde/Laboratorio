...
/**
 * <h2>Ejemplo educativo de manejo de archivos en Java 12 con
 * JFileChooser.</h2>
 * 
 * <p>
 ...
 * 
 * <p>
 * Fue diseñado para estudiantes de <b>Programación I</b> como introducción
 * a la
...
public class MainPadron {
     ...
     * {@link JFileChooser}.
     * El archivo seleccionado se almacena en la variable 
     * {@code archivoSeleccionado}.
     */
    public static void seleccionarArchivo() {
        JFileChooser chooser = new JFileChooser();
        chooser.setDialogTitle("Seleccione el archivo PUGOLFITO.txt");
    ...
    /**
     * Cuenta y muestra en consola la cantidad de líneas del archivo 
     * actualmente seleccionado.
     * Utiliza {@link BufferedReader} para leer el archivo línea por línea.
     */
    ...
    /**
     * Permite al usuario buscar personas por su apellido dentro del 
     * archivo seleccionado.
     * Muestra en consola todas las líneas que contengan el texto indicado.
     */
     ...
     * permite al usuario guardar los resultados en un nuevo archivo.
     * Utiliza {@link JFileChooser} para elegir la ubicación de guardado.
     */
     ...
     * únicos encontrados.
     * Usa un {@link HashSet} para evitar duplicados.
     */
     ...
     *
     * @return {@code true} si el archivo es válido, {@code false}
     * en caso contrario
     */
